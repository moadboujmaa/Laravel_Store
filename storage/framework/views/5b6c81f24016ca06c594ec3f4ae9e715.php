...
<?php endif; ?>
        ...
        <div class="mt-4">
            ...
            <?php if(Route::has('password.request')): ?>
                <a class="block text-sm text-center text-gray-600 underline rounded-md dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800" href="<?php echo e(route('password.request')); ?>">
...
<?php endif; ?>
<?php /**PATH D:\Laravel_Store\resources\views/auth/login.blade.php ENDPATH**/ ?>